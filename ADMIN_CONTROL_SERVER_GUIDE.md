...
## Overview
  ...
  qqscentralized management system for controlling patient and doctor accounts, managing credentials, and monitoring system-wide data. It provides administrators with tools to:
